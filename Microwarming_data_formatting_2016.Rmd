...
rm(late1, late2, late3, late4) %>% filter(!is.na(time))
...
for(i in 1:length(combinations$block)) {
  ...
  early <- early.all %>% filter(block == plot, depth == cm, type == MC, heatStat == HU, regStat == RM, dist == distance, is.na(flag)) #isolate a given trace, minus values that were already flagged as bad data
...
flagged.early <- early.all %>% filter(!is.na(flag)) %>% full_join(flagged.early)
```
...
for(i in 1:length(combinations$block)) {
  ...
  late <- late.all %>% filter(block == plot, depth == cm, type == MC, heatStat == HU, regStat == RM, dist == distance, is.na(flag)) #isolate a given trace, minus values that were already flagged as bad data
...
#add back in rows that were previously flagged
flagged.late <- late.all %>% filter(!is.na(flag)) %>% full_join(flagged.late)
...
```{r}
write.csv(flagged, file = "data/2016_organized/flaggedBarrowFile_2016_6.csv") 
```

####Optional: read in flagged file and format time variable
```{r}
# flagged <- read.csv('data/2016_organized/flaggedBarrowFile_2016_6.csv', stringsAsFactors=F) 
# 
...
outliers <- flagged %>% filter(date == "2016-06-17", block == 1, heatStat == "U") #modify filter criteria to explore other dates/blocks
...
write.csv(mean.15min, file = "data/2016_organized/flaggedBarrowFile.15min_2016_6.csv") 

#temperatures averaged for each probe, every 15-min interval, outliers omitted
write.csv(mean.15min.probe, file = "data/2016_organized/flaggedBarrowFile.15min.probe_2016_6")

#temperatures averaged for each distance from the plot center, every 15-min interval, outliers omitted
write.csv(mean.15min.dist, file = "data/2016_organized/flaggedBarrowFile.15min.dist_2016_2")

#temperatures averaged for each plot and depth for every 1-hour interval, outliers omitted
write.csv(mean.hour, file = "data/2016_organized/flaggedBarrowFile.1hour_2016_6.csv") 

#temperatures averaged for each probe, every 1-hour interval, outliers omitted
write.csv(mean.hour.probe, file = "data/2016_organized/flaggedBarrowFile.1hour.probe_2016_6")

#temperatures averaged for each distance from the plot center, every 1-hour interval, outliers omitted
write.csv(mean.hour.dist, file = "data/2016_organized/flaggedBarrowFile.hour.dist_2016_2")

#temperatures averaged for each plot and depth for every 4-hour interval, outliers omitted
write.csv(mean.4hour, file = "data/2016_organized/flaggedBarrowFile.4hour_2016_6.csv") 

#temperatures averaged for each probe, every 4-hour interval, outliers omitted
write.csv(mean.4hour.probe, file = "data/2016_organized/flaggedBarrowFile.4hour.probe_2016_6")

#temperatures averaged for each distance from the plot center, every 4-hour interval, outliers omitted
write.csv(mean.4hour.dist, file = "data/2016_organized/flaggedBarrowFile.4hour.dist_2016_2")

#temperatures averaged for each plot and depth for every 6-hour interval, outliers omitted
write.csv(mean.6hour, file = "data/2016_organized/flaggedBarrowFile.6hour_2016_6.csv") 

#temperatures averaged for each probe, every 6-hour interval, outliers omitted
write.csv(mean.6hour.probe, file = "data/2016_organized/flaggedBarrowFile.6hour.probe_2016_6")

#temperatures averaged for each distance from the plot center, every 6-hour interval, outliers omitted
write.csv(mean.6hour.dist, file = "data/2016_organized/flaggedBarrowFile.6hour.dist_2016_2")
```
...
write.csv(mean.15min.depthavg, file = "data/2016_organized/flaggedBarrowFile.15min.avg_2016_6.csv") 

write.csv(mean.hour.depthavg, file = "data/2016_organized/flaggedBarrowFile.1hour.avg_2016_6.csv") 

write.csv(mean.hour.depthavg.lim, file = "data/2015_organized/flaggedBarrowFile.1hour.avg.lim_2016_6.csv") 

write.csv(mean.4hour.depthavg, file = "data/2016_organized/flaggedBarrowFile.4hour.avg_2016_6.csv") 

write.csv(mean.6hour.depthavg, file = "data/2016_organized/flaggedBarrowFile.6hour.avg_2016_6.csv") 
...
```{r}
#temperatures averaged across all depths for every 15-minute interval, outliers ommitted
write.csv(mean.15min.blockavg, file = "data/2016_organized/flaggedBarrowFile.15min.blocks_2016_6.csv") 

write.csv(mean.hour.blockavg, file = "data/2016_organized/flaggedBarrowFile.1hour.blocks_2016_6.csv") 

write.csv(mean.4hour.blockavg, file = "data/2016_organized/flaggedBarrowFile.4hour.blocks_2016_6.csv") 

write.csv(mean.6hour.blockavg, file = "data/2016_organized/flaggedBarrowFile.6hour.blocks_2016_6.csv") 
```
...
write.csv(mean.hour.tdiff, file = "data/2016_organized/flaggedBarrowFile.1hour.Tdiff_2016_2.csv") 
```
...
write.csv(ranges, file = "data/2016_organized/flaggedBarrowFile.1hour.range_2016_6.csv")
```