...
p1 + plottheme + theme(legend.position = c(.05, .2)) 
...
ggsave("flagged_TempDiff_15min_2015_2.png", path="plots/outliers_omitted/2015", width = 14, height = 7, dpi = 300)
...
p2 + plottheme + theme(legend.position = c(.05, .2)) 
...
p3 + plottheme + theme(legend.position = c(.05, .2)) 
...
p4 + plottheme + theme(legend.position = c(.05, .2)) 

#ggsave("TempDiff_2015.png", path="plots", width = 14, height = 7, dpi = 300)
#ggsave("flagged_TempDiff_6h_2016_5.png", path="plots/outliers_omitted/2016", width = 14, height = 7, dpi = 300)
ggsave("flagged_TempDiff_6h_2015_2.png", path="plots/outliers_omitted/2015", width = 14, height = 7, dpi = 300)
...
#1-hour averages
p2 <- ggplot(mean.hour.depthavg %>% filter(block != "unknown"), aes(y=TempDiff, x=time_hour, color=as.factor(as.character(data.type)))) +
...
p5 <- ggplot(heatstat.15min.avg %>% filter(block %in% c(1,2,3,4)), aes(y = temp_15min, x = time_15min, color = Heatstat)) +
 ...
 p5 + plottheme + theme(legend.position = c(.1, .2))
...
p6 + plottheme + theme(legend.position = c(.1, .2))
...
#4-hour averages
heatstat.4hour.avg <- gather(mean.4hour.depthavg, key="Heatstat", value="temp_4hour", UnheatedMean:HeatedMean)
...
p7 + plottheme + theme(legend.position = c(.1, .2))
 
#ggsave("flagged_UavgHavg_4h_2016_5.png", path="plots/outliers_omitted/2016", width = 14, height = 7, dpi = 300)
ggsave("flagged_UavgHavg_4h_2015_2.png", path="plots/outliers_omitted/2015", width = 14, height = 7, dpi = 300)

#6-hour averages
heatstat.6hour.avg <- gather(mean.6hour.depthavg, key="Heatstat", value="temp_6hour", UnheatedMean:HeatedMean)
...
p8 + plottheme + theme(legend.position = c(.1, .2))
 
#ggsave("flagged_UavgHavg_6h_2016_5.png", path="plots/outliers_omitted/2016", width = 14, height = 7, dpi = 300)
ggsave("flagged_UavgHavg_6h_2015_2.png", path="plots/outliers_omitted/2015", width = 14, height = 7, dpi = 300)
```

####Plot 3: Temperature in heated and unheated plots within each block at each depth.  You can see that heating effects vary widely among different blocks and depths. 
```{r}
#15-min averages
chambers <- mean.15min 
...
ggsave(file = paste("flagged_", plot, "_4h_tempdepth_2015.png", sep=""), path="plots/outliers_omitted/2015", width = 8.5, height = 11, dpi = 300)
...
for(i in 1:length(unique(chambers$block))){
  ...
  p5 <- ggplot(mean.hour.dist %>% filter(block == plot), aes(y = temp, x = time_hour, color = heatStat)) +
  geom_point(pch = 1, size = 0.5) +
