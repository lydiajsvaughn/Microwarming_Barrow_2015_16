...
July <- read.csv('data/2015_organized/longBarrowFile_2015_July_2.csv', stringsAsFactors=F) #hopefully all the missing data
...
```{r}
write.csv(flagged, file = "data/2015_organized/flaggedBarrowFile_2015_4.csv") 
write.csv(long, file = "data/2015_organized/long_alldata_2015_4.csv") 
```
...
write.csv(mean.15min, file = "data/2015_organized/flaggedBarrowFile.15min_2015_4.csv") 

#temperatures averaged for each probe, every 15-min interval, outliers omitted
write.csv(mean.15min.probe, file = "data/2015_organized/flaggedBarrowFile.15min.probe_2015_4")

#temperatures averaged for each distance from the plot center, every 15-min interval, outliers omitted
write.csv(mean.15min.dist, file = "data/2015_organized/flaggedBarrowFile.15min.dist_2015_4")

#temperatures averaged for each plot and depth for every 1-hour interval, outliers omitted
write.csv(mean.hour, file = "data/2015_organized/flaggedBarrowFile.1hour_2015_4.csv") 

#temperatures averaged for each probe, every 1-hour interval, outliers omitted
write.csv(mean.hour.probe, file = "data/2015_organized/flaggedBarrowFile.1hour.probe_2015_4")

#temperatures averaged for each distance from the plot center, every 1-hour interval, outliers omitted
write.csv(mean.hour.dist, file = "data/2015_organized/flaggedBarrowFile.hour.dist_2015_4")

#temperatures averaged for each plot and depth for every 4-hour interval, outliers omitted
write.csv(mean.4hour, file = "data/2015_organized/flaggedBarrowFile.4hour_2015_4.csv") 

#temperatures averaged for each probe, every 4-hour interval, outliers omitted
write.csv(mean.4hour.probe, file = "data/2015_organized/flaggedBarrowFile.4hour.probe_2015_4")

#temperatures averaged for each distance from the plot center, every 4-hour interval, outliers omitted
write.csv(mean.4hour.dist, file = "data/2015_organized/flaggedBarrowFile.4hour.dist_2015_4")

#temperatures averaged for each plot and depth for every 6-hour interval, outliers omitted
write.csv(mean.6hour, file = "data/2015_organized/flaggedBarrowFile.6hour_2015_4.csv") 

#temperatures averaged for each probe, every 6-hour interval, outliers omitted
write.csv(mean.6hour.probe, file = "data/2015_organized/flaggedBarrowFile.6hour.probe_2015_4")

#temperatures averaged for each distance from the plot center, every 6-hour interval, outliers omitted
write.csv(mean.6hour.dist, file = "data/2015_organized/flaggedBarrowFile.6hour.dist_2015_4")
...
write.csv(mean.15min.depthavg, file = "data/2015_organized/flaggedBarrowFile.15min.avg_2015_4.csv") 

write.csv(mean.hour.depthavg, file = "data/2015_organized/flaggedBarrowFile.1hour.avg_2015_4.csv") 

write.csv(mean.hour.depthavg.lim, file = "data/2015_organized/flaggedBarrowFile.1hour.avg.lim_2015_4.csv") 

write.csv(mean.4hour.depthavg, file = "data/2015_organized/flaggedBarrowFile.4hour.avg_2015_4.csv") 

write.csv(mean.6hour.depthavg, file = "data/2015_organized/flaggedBarrowFile.6hour.avg_2015_4.csv") 
...
```{r}
#temperatures averaged across all depths for every 15-minute interval, outliers ommitted
write.csv(mean.15min.blockavg, file = "data/2015_organized/flaggedBarrowFile.15min.blocks_2015_4.csv") 

write.csv(mean.hour.blockavg, file = "data/2015_organized/flaggedBarrowFile.1hour.blocks_2015_4.csv") 

write.csv(mean.4hour.blockavg, file = "data/2015_organized/flaggedBarrowFile.4hour.blocks_2015_4.csv") 

write.csv(mean.6hour.blockavg, file = "data/2015_organized/flaggedBarrowFile.6hour.blocks_2015_4.csv") 
```
...
write.csv(mean.hour.tdiff, file = "data/2015_organized/flaggedBarrowFile.1hour.Tdiff_2015_4.csv") 
```
...
write.csv(ranges, file = "data/2015_organized/flaggedBarrowFile.1hour.range_2015_4.csv")
```